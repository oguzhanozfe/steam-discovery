...
export const metadata: Metadata = {
  ...
  title: 'Steam Discovery — Indie Marketing Intelligence',
  description: '48 game cases and benchmarks, 31 source readings, quarterly market evidence, niche maps and scoped experiment briefs for indie teams.',
  openGraph: {
    title: 'Steam Discovery — Indie Marketing Intelligence',
