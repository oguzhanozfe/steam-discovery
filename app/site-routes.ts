...
export const sectionRoutes: SiteRoute[] = [
  { path: '/', title: 'Steam Discovery — Indie Game Marketing & Market Research', description: 'Source-backed Steam marketing research: indie game case studies, wishlist campaigns, genre demand and annotated expert readings for game developers.', initial: { view: 'stories' }, modifiedAt: readingUpdatedAt },
